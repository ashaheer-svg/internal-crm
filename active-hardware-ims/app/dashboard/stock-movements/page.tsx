                ...
                <div className="space-y-4">
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                        ...
                        <ol className="text-sm text-green-700 space-y-1 list-decimal list-inside">
                            <li>Go to Transactions → Delivery Orders tab</li>
                            <li>Click "New Delivery Order"</li>
                            <li>Enter consignee/customer details</li>
                            <li>Select items from available inventory</li>
                            <li>Create Delivery Order - items will be dispatched</li>
                        </ol>
                    </div>

                    <div className="bg-white shadow sm:rounded-lg p-6">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-lg font-medium text-gray-900">Create New Delivery Order</h2>
                            <Link
                        ...
                        <p className="text-sm text-gray-500">
                            Create delivery orders to issue stock to customers. The system will automatically mark items and create movement logs.
                        </p>
                    </div>
